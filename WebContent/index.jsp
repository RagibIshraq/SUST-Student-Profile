					...
					<div class="nav-header" >
						...
						<nav id="fh5co-menu-wrap" role="navigation">
							<ul class="sf-menu" id="fh5co-primary-menu">
								...
								<li>
									<a href="PublicSearch.jsp">Search Students</a>
								</li>
								
								<!-- Login PopUp  -->
								<li>
									<a class="popup-button" href="#popup1">Login</a>
								...
								<!-- Sign Up PopUp  -->
								<li>
									<a class="popup-button" href="#popup2">Sign Up</a>
										...
										<div class="popup">
											...
											<div class="content">
												<form action="SignUpVerification" method="post"> 
													...
													UserReg: <input type="number" name= "user_reg"/><br> 
													Email:<input type="text" name="email_id"/><br/><br/>  
													Password:<input type="password" name="user_pass"/><br/><br/>  
